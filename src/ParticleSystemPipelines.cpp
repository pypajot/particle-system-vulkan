...
ParticleSystemPipelines::ParticleSystemPipelines() {}

ParticleSystemPipelines::~ParticleSystemPipelines() {}

void ParticleSystemPipelines::bindDevice(VkDevice appDevice)
{
    device = appDevice;
}

VkShaderModule ParticleSystemPipelines::createShaderModule(const std::vector<char>& code)
{
...
void ParticleSystemPipelines::createShadowMapModelPipeline()
{
...
void ParticleSystemPipelines::createShadowMapParticlePipeline()
{
...
void ParticleSystemPipelines::createGraphicsPipeline()
{
...
void ParticleSystemPipelines::createParticleGraphicsPipeline()
{
...
void ParticleSystemPipelines::createParticleInitPipeline()
{
...
void ParticleSystemPipelines::createParticleUpdatePipeline()
{
